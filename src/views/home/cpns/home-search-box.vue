<template>
    <div class="search-box">
        ...
        <van-calendar v-model:show="showCalender" @confirm="onConfirm" type="range" color="#ff9854" :round="false" />
...
const onConfirm = (value) => {
    ...
    stayCount.value = ref(getDiffDays(selectStartDate, selectEndDate))
