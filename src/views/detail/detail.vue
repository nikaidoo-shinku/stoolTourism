<template>
  <div class="detail top-page" ref="detailRef">
    <tab-control class="tabs" v-if="showTabControl" :titles="names" @tabItemClick="tabClick" ref="tabControlRef"></tab-control>
...
const detailRef = ref()
const { scollTop } = useScroll()
const showTabControl = computed(() => {
  return scollTop.value >= 300
})
